...
contract UniswapV2Router02 is IUniswapV2Router02 {
    ...
    function getReserves(
        address tokenA,
        address tokenB
    ) external view override returns (uint reserveA, uint reserveB) {
        ...
        returns (uint amountToken, uint amountHBAR, uint liquidity)
    {
        ...
        if (msg.value > amountHBAR)
            TransferHelper.safeTransferHBAR(msg.sender, msg.value - amountHBAR);
    }
    ...
    function removeLiquidityHBAR(
        ...
        returns (uint amountToken, uint amountHBAR)
    {
        ...
        returns (uint[] memory amounts)
    {
        ...
        if (msg.value > amounts[0])
            TransferHelper.safeTransferHBAR(msg.sender, msg.value - amounts[0]);
    }
