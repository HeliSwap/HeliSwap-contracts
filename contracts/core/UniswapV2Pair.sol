...
*
* HeliSwap team modified the `UniswapV2Pair` contract in order to add support for HTS tokens and emit additional
* metadata during `Sync` events
/******************************************************************************/
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    event Mint(address indexed sender, uint amount0, uint amount1, address indexed to, uint amountLp);
